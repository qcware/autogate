...
.def_static("X", &GateLibrary::X)
.def_static("Y", &GateLibrary::Y)
.def_static("Z", &GateLibrary::Z)
.def_static("H", &GateLibrary::H)
.def_static("Ry", &GateLibrary::Ry, "symbol"_a, "order"_a=1)
.def_static("oX", &GateLibrary::oX)
.def_static("oY", &GateLibrary::oY)
.def_static("oZ", &GateLibrary::oZ)
.def_static("oH", &GateLibrary::oH)
.def_static("cX", &GateLibrary::cX)
.def_static("cY", &GateLibrary::cY)
.def_static("cZ", &GateLibrary::cZ)
.def_static("cH", &GateLibrary::cH)
.def_static("cRy", &GateLibrary::cRy, "symbol"_a, "order"_a=1)
.def_static("G", &GateLibrary::G, "symbol"_a, "order"_a=1)
;
